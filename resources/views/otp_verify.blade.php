...
<html class="no-js" lang="en">
  ...
  <div class="card">
    ...
    <div class="auth-content">
      <form id="signup-form"  action="{{ route('verifyUser') }}" method="POST" novalidate="">
        @csrf
        ...
        <div class="form-group">
          ...
          <div class="row">
            <div class="col-sm-12">
              <input type="password" class="form-control underlined" name="user_otp" id="otp" placeholder="Please enter your 4 digit OTP no here" required="" autocomplete="off" value="{{ old('otp')}}" maxlength="4">
            </div>
          </div>
       ...
       <?php  //$user_id = $data['user_id']; ?>
        {{-- <input type="hidden" name="otp" value="{{ $data['0']['otp'] }}">
        <input type="hidden" name="UserId" value="{{ $data['0']['user_id'] }}">
